...
/**
 * @fileoverview Unit tests for the explore tab base page.
 *
...
function testGetDetailsInfo() {
  var runKeyStr = 'abc';
  var view = new bite.server.explore.Tab();
  view.getDetailsInfo(runKeyStr);
  var sendInstance = goog.testing.net.XhrIo.getSendInstances()[0];
  var sentUri = sendInstance.getLastUri();
  assertEquals('/run/get_details', sentUri);
}
