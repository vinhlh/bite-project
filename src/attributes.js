    ...
    xpathTable = goog.dom.createDom(goog.dom.TagName.TABLE,
        ...
        goog.dom.createDom(goog.dom.TagName.TR, {},
            goog.dom.createDom(goog.dom.TagName.TD,
                {'class': 'console-attributes-row-div'}, 'Xpath'),
            goog.dom.createDom(goog.dom.TagName.TD,
                {'width': '80%'},
 ...
 * @private
 */
rpf.Attributes.prototype.onTabSelected_ = function(
    e) {
  var tabSelected = e.target;
  var level = parseInt(tabSelected.getContentElement().id.substring(6), 10);
